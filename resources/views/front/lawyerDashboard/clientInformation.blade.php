...
<div class="page-header">
	<div class="row align-items-end">
		...
		<div class="col-lg-4">
			<nav class="breadcrumb-container" aria-label="breadcrumb">
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item active" aria-current="page">معلومات العملاء</li>
				</ol>
			</nav>
		</div>
	</div>
        ...
        <script src="{{asset('assets/lawyerDashboardplugins/popper.js/dist/umd/popper.min.js')}}"></script>
        <script src="{{asset('assets/lawyerDashboardplugins/bootstrap/dist/js/bootstrap.min.js')}}"></script>
        <script src="{{asset('assets/lawyerDashboardplugins/perfect-scrollbar/dist/perfect-scrollbar.min.js')}}"></script>
        <script src="{{asset('assets/lawyerDashboardplugins/screenfull/dist/screenfull.js')}}"></script>
        <script src="{{asset('assets/lawyerDashboardplugins/datatables.net/js/jquery.dataTables.min.js')}}"></script>
        <script src="{{asset('assets/lawyerDashboardplugins/datatables.net-bs4/js/dataTables.bootstrap4.min.js')}}"></script>
        <script src="{{asset('assets/lawyerDashboardplugins/moment/moment.js')}}"></script>
        <script src="{{asset('assets/lawyerDashboardplugins/jquery-toast-plugin/dist/jquery.toast.min.js')}}"></script>
