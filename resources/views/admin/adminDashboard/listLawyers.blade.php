								...
								<div class="col-lg-4">
									<nav class="breadcrumb-container" aria-label="breadcrumb">
										<ol class="breadcrumb">
											...
											<li class="breadcrumb-item active" aria-current="page">المحامين</li>
										</ol>
									</nav>
								</div>
							</div>
                                            ...
                                            <table id="advanced_table" class="table table-striped table-bordered table-hover mb-0">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center"><strong class="badge bg-success text-light"><a style="color:white" href="{{route('admin.lawyers.status',$lawyer -> id)}}">@if($lawyer -> active == 0)
                                                                        تفعيل
                                                                        @else
                                                                        الغاء تفعيل
                                                                    @endif</a></strong></td>
                                                        <td class="text-center">
															<div class="action-btns">{{$lawyer ->id}}
																<a data-toggle="tooltip" data-placement="top" title="ملف المحامي" class="btn btn-icon btn-dark btn-view-profile" href="{{route('admins.profileLawyer',$lawyer -> id)}}"><i class="ik ik-user f-16 mr-10"></i></a>
																<a href="{{route('admins.deleteLawyer',$lawyer -> id)}}" data-target="#deleteModal" class="btn btn-icon btn-danger btn-add-Delete" href='#'><i class="ik ik-trash-2 f-16 mr-10" data-toggle="tooltip" data-placement="top" title="حذف" ></i></a>
                                                    ...
                                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="deleteModalLabel">حذف المحامي {{$lawyer ->id}}</h5>
                                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                            </div>
                                                            <div class="modal-body">
                                                            هل متأكد من عملية حذف هذا المحامي ؟
                                                            </div>
                                                            <div class="modal-footer">
                                                                <a href="{{route('admins.deleteLawyer',$lawyer -> id)}}"><button type="button" class="btn btn-danger">حذف</button></a>
