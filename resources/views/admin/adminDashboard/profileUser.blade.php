	...
	<div class="row align-items-end">
		<div class="col-lg-8">
			<div class="page-header-title">
				...
				<div class="d-inline">
					<h2>الملف الشخصي</h2>
					<span>عرض وتعديل بيانات المستخدم</span>
				</div>
			</div>
		</div>
		<div class="col-lg-4">
...
<div class="col-md-12">
	...
	<div class="row">
      ...
      <div class="col-md-8 offset-md-1 personal-info">
        ...
        <h3 class="mb-40">الملف الشخصي المستخدم</h3>
        @include('admin.includes.alerts.success')
        @include('admin.includes.alerts.errors')
        <form action="{{route('admins.updateProfileUser',$user -> id)}}" method="POST" class="form-horizontal" role="form">
        @csrf
          ...
          <div class="form-group row">
            ...
            <div class="col-md-5">
			  <div class="input-group">
				<input name="phone" type="tel" id="phone" value="{{$user ->phone}}" class="telephone form-control text-left">
                @error('phone')
                  <div class="text-danger">{{$message}}</div>
                @enderror
			  </div>
