                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
															<div class="action-btns">
																<a href="{{route('admins.profileUser',$user -> id)}}" data-toggle="tooltip" data-placement="top" title="ملف المحامي" class="btn btn-icon btn-dark btn-view-profile" href='#'><i class="ik ik-user f-16 mr-10"></i></a><!--profileUser.html-->
																<a href="{{route('admins.deleteUser',$user -> id)}}" data-target="#deleteModal" class="btn btn-icon btn-danger btn-add-Delete" href='#'><i class="ik ik-trash-2 f-16 mr-10" data-toggle="tooltip" data-placement="top" title="حذف" ></i></a>
															</div>
														</td>
                                                    </tr>
                                                    @endforeach
                        ...
                        <!--<div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    ...
                                    هل متأكد من عملية حذف هذا المستخدم ؟
                                    </div>
